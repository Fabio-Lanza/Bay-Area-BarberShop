...
async function seedDatabase() {
  try {
    ...
    const services = [
        ...
        {
          name: "Beard",
          description: "Complete styling to highlight your masculinity.",
          price: 40.0,
          imageUrl:
        ...
        {
          name: "Edge Up",
          description: "Perfect finishing for a refreshed look.",
          price: 35.0,
          imageUrl:
        ...
        {
          name: "Massage",
          description: "Relax with a rejuvenating massage.",
          price: 50.0,
          imageUrl:
